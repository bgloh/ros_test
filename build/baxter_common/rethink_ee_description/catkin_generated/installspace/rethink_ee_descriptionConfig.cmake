...
if("FALSE" STREQUAL "TRUE")
  set(rethink_ee_description_SOURCE_PREFIX /home/brian/catkin_ws/src/baxter_common/rethink_ee_description)
  set(rethink_ee_description_DEVEL_PREFIX /home/brian/catkin_ws/devel)
  ...
  set(rethink_ee_description_INSTALL_PREFIX /home/brian/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rethink_ee_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/brian/catkin_ws/install/${idir}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rethink_ee_description_dep}_FOUND)
      find_package(${rethink_ee_description_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rethink_ee_description_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
