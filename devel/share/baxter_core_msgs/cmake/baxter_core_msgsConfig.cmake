...
if("TRUE" STREQUAL "TRUE")
  set(baxter_core_msgs_SOURCE_PREFIX /home/brian/catkin_ws/src/baxter_common/baxter_core_msgs)
  set(baxter_core_msgs_DEVEL_PREFIX /home/brian/catkin_ws/devel)
  ...
  set(baxter_core_msgs_INSTALL_PREFIX /home/brian/catkin_ws/install)
...
if(NOT "/home/brian/catkin_ws/devel/include " STREQUAL " ")
  set(baxter_core_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/brian/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_core_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/brian/catkin_ws/src/baxter_common/baxter_core_msgs/${idir}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
    endif()
...
set(baxter_core_msgs_EXPORTED_TARGETS "baxter_core_msgs_generate_messages_cpp;baxter_core_msgs_generate_messages_eus;baxter_core_msgs_generate_messages_lisp;baxter_core_msgs_generate_messages_nodejs;baxter_core_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${baxter_core_msgs_dep}_FOUND)
      find_package(${baxter_core_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${baxter_core_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
